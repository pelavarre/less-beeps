...
```
git clone https://github.com/pelavarre/less-beeps.git && cd less-beeps/
...
**Tested on** iPad, iPhone, MacBook, & Linuxes <br>
**Requirements** Python 3, Terminal <br>
...
that you get by trying to draw with only tall thin characters
...
Or describe the Keys you mean to press even while they're missing from your Keyboard
> python3 bin/less-beeps.py Fn F1 <br>


## Installation Options

### macOS
Find a macOS Terminal in **Finder → Go → Utilities**

### iOS
Find a Linux Terminal on the Internet inside **Safari** or **Chrome**,
inside iOS, macOS, etc

### Windows
Run **Python** directly inside a Windows Command Prompt.
Or run Python inside the Windows Subsystem for Linux (WSL)

### Your Linux

Odds on, you already do know how to find a Terminal in your Linux, if you have a Linux
...
The Google Cloud Shell Terminal works fine either way.
...
Do you know someone who knows someone at Google?
Can you tell them to stop hassling us with these silly authorization prompts?
Learn to take No for an answer?

## Spirit

These games preserve the spirit of classic computing:
simple, hackable, and client-controlled

You are the client.
While graphics have improved (thanks to Unicode!),
this core experience remains timeless:
games that respond to how you want to play them


## Why "Less-Beeps"?

The constant beepping was the rudest move
...
when you find max whimsy with least noise
